...
from ..adaptors.hybrid_embedding_adapter import HybridEmbeddingAdapter
...
class EmbedderFactory:
    ...
    def get_embedder(name: str, **kwargs) -> BaseEmbedding:
        ...
        elif name in ["ollama", "ollama-embed-text"]:
            return OllamaEmbeddingAdapter(**kwargs)
        elif name in ["hybrid", "hybrid-ollama", "hybrid-embedding"]:
            return HybridEmbeddingAdapter(**kwargs)
        else:
